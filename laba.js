...
document.write('<tr style="background:#FFF;font:12px Arial;color:#FF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#FF" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
	...
	for(var d=1;d<=42;d++) {
		...
		if ((d >= (cd -(-1)))&&(d<=cd-(-marr[cm]))) {
			...
			if (sccm == cm && sccd == (d-cd) && sccy == cy)
			    cv.style.color = '#aaaecf';

			// if selected date
			if (cm == selectedm && cy == selectedy && selectedd == (d-cd) )
			{
			    cv.style.background = '#aaaecf';
